...
namespace NguyenAnhTuanSachOnline.Controllers
{
    public class GioHangController : Controller
    {
        ...
        private void GuiEmail(string toEmail, string subject, string body)
        {
            ...
            mail.To.Add(toEmail);
            mail.From = new MailAddress("2124802010521@student.tdmu.edu.vn");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("2124802010521@student.tdmu.edu.vn", "tuan1060369"); // Thay đổi thành email và mật khẩu của bạn
            smtp.EnableSsl = true;
